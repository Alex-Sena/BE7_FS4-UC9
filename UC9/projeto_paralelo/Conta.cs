...
/*
Metodos
possuem o modificar de visibilidade (public, private, protected...)
retorno (bool, string, int, double, float, objeto de uma classe, lista, void...)
nome do metodo (padrão não é regra, mas é bom seguir... iniicais minusculas e demotam ação...
exemplos verbos infinitivo...Depositar, Sacar, Imprimir, Verificar, Calcular...etc)
argumentos (são os valores, que podem existir ou não, para que um metodo funcione. Chamamos de assinatura do metodo)
*/
